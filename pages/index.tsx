      ...
      <div className="main-wrapper">
            ...
            <div className="page-wrapper">-
                ...
                <div className="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                  ...
                  <div className="d-flex align-items-center flex-wrap text-nowrap">
                    <div className="input-group date datepicker wd-200 me-2 mb-2 mb-md-0" id="dashboardDate">
                      <span className="input-group-text input-group-addon bg-transparent border-primary"><i data-feather="calendar" className=" text-primary"></i></span>
              ...
              <footer className="footer d-flex flex-column flex-md-row align-items-center justify-content-between px-4 py-3 border-top small">
                <p className="text-muted mb-1 mb-md-0">Copyright © 2022 <a href="https://www.nobleui.com">NobleUI</a>.</p>
                <p className="text-muted">Handcrafted With <i className="mb-1 text-primary ms-1 icon-sm" data-feather="heart"></i></p>
              </footer>
              {/* <!-- partial --> */}
