...
export default function index() {
  return (
    <section className="tambahlogbook overflow-auto">
        <SideBar activeMenu="tambahlogbook"/>
        
        <main className="main-wrapper">
            <div className="ps-lg-0">
                <h2 className="text-4xl fw-bold color-palette-1 mb-30">Tambah Logbook</h2>
                    ...
                    <form action="">
                        <div className="pt-30">
                            ...
                            <input type="text" className="form-control rounded-pill text-lg" id="title" name="title"
                                aria-describedby="title" placeholder="Masukkan Judul Kegiatan Anda"/>
                        </div>
                        <div className="pt-30">
                            ...
                            <input type="text" className="form-control rounded-pill text-lg" id="instansi" name="instansi"
                                aria-describedby="instansi" placeholder="Masukkan Instansi Projek Anda"/>
                        </div>
                        <div className="pt-30">
                        ...
                        <div className="pt-30">
                            ...
                            <textarea className="form-control rounded-pill text-lg" id="deskripsi" name="deskripsi" 
                                aria-describedby="deskripsi" placeholder="Masukkan Deskripsi Kegiatan Anda"/>
                        </div>
                        <div className="button-group d-flex flex-column pt-50">
                            <button type="submit" className="btn btn-save fw-medium text-lg text-white rounded-pill"
                                role="button">Tambahkan Logbook</button>
                        </div>
                    </form>
