...
export default function SignUpForm() {
  return (
      <>
        ...
        <p className="text-lg color-palette-1 m-0">Daftar untuk melakukan pengisian Logbook Anda</p>
        <div className="pt-50">
            <label for="name" className="form-label text-lg fw-medium color-palette-1 mb-10">Nama Lengkap</label>
