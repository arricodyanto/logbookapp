export default function SignInForm() {
  return (
      <>
        ...
        <p className="text-lg color-palette-1 m-0">Masuk untuk melakukan pengisian Logbook Anda </p>
        <div className="pt-50">
            ...
            <input type="email" className="form-control rounded-pill text-lg" id="email" name="email"
                aria-describedby="email" placeholder="Masukkan alamat email"/>
        </div>
        <div className="pt-30">
            <label for="password"
            ...
            <input type="password" className="form-control rounded-pill text-lg" id="password"
                name="password" aria-describedby="password" placeholder="Masukkan password"/>
        </div>
        <div className="button-group d-flex flex-column mx-auto pt-50">
            <a className="btn btn-sign-in fw-medium text-lg text-white rounded-pill mb-16"
                href="/user" role="button">Continue to Sign In</a>
